...
// CheckUserHavePassedTTPByHash is a free data retrieval call binding the contract method 0x6adbcfdf.
//
// Solidity: function checkUserHavePassedTTP_ByHash(string mrz_uid_hash) view returns(bool)
func (_EPassport *EPassportCaller) CheckUserHavePassedTTPByHash(opts *bind.CallOpts, mrz_uid_hash string) (bool, error) {
	var out []interface{}
...
//
// Solidity: function checkUserHavePassedTTP_ByHash(string mrz_uid_hash) view returns(bool)
func (_EPassport *EPassportSession) CheckUserHavePassedTTPByHash(mrz_uid_hash string) (bool, error) {
...
//
// Solidity: function checkUserHavePassedTTP_ByHash(string mrz_uid_hash) view returns(bool)
func (_EPassport *EPassportCallerSession) CheckUserHavePassedTTPByHash(mrz_uid_hash string) (bool, error) {
	return _EPassport.Contract.CheckUserHavePassedTTPByHash(&_EPassport.CallOpts, mrz_uid_hash)
}
...
// ProoveUserByTTP is a paid mutator transaction binding the contract method 0x044abf16.
//
// Solidity: function ProoveUserByTTP(address user, uint8 id_type, string mrz_uid_hash) returns()
func (_EPassport *EPassportTransactor) ProoveUserByTTP(opts *bind.TransactOpts, user common.Address, id_type uint8, mrz_uid_hash string) (*types.Transaction, error) {
...
//
// Solidity: function ProoveUserByTTP(address user, uint8 id_type, string mrz_uid_hash) returns()
func (_EPassport *EPassportSession) ProoveUserByTTP(user common.Address, id_type uint8, mrz_uid_hash string) (*types.Transaction, error) {
...
//
// Solidity: function ProoveUserByTTP(address user, uint8 id_type, string mrz_uid_hash) returns()
func (_EPassport *EPassportTransactorSession) ProoveUserByTTP(user common.Address, id_type uint8, mrz_uid_hash string) (*types.Transaction, error) {
	return _EPassport.Contract.ProoveUserByTTP(&_EPassport.TransactOpts, user, id_type, mrz_uid_hash)
}
